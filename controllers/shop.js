...
exports.getProduct = (req, res) => {
    ...
    Product.findById(prodId)
        .then(product => {
            res.render('shop/product-detail', { pageTitle: product.title, path: '', isAuthenticated: req.isLoggedIn, product: product });
        })
        .catch(err => console.log(err));
};
...
exports.getCart = (req, res) => {
    req.user
        ...
        .then(user => {
            ...
            res.render('shop/cart', { pageTitle: 'Your Cart', path: '/cart', isAuthenticated: req.isLoggedIn, products: products });
        })
        .catch(err => console.log(err));
};
